        ...
        <ul className="flex items-center space-x-5">
          ...
          <li>
            <button
              ...
              className="bg-blue-100 cursor-pointer dark:bg-blue-900 rounded-lg p-1 inline-block"
            >
              <img
          ...
          <li>
            ...
            >
              <div className="flex relative justify-between items-center">
                ...
                {cartData.length > 0 && (
                  <span className="text-white font-bold absolute bg-[#39e1aa] py-0 px-2 -top-4 left-3 rounded-full ">
                    {cartData.length}
                  </span>
                )}
              </div>
